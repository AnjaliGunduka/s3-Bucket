package com.s3.fileapis.controller;
...
import com.s3.fileapis.common.Constants;
import com.s3.fileapis.service.StorageService;
...
public class StorageController {
	...
	public ResponseEntity<String> uploadFile(@RequestPart("file") MultipartFile file) throws AmazonClientException, IOException {
	...
	public ResponseEntity<?> downloadFile(@PathVariable("fileName") String fileName) throws AmazonClientException, IOException {
